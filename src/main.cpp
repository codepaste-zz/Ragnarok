...
uint256 hashGenesisBlock("0xd0ba2f651d7fc5e51b925ca50836e178a7f17c09246700616449976e41525335");
...
const string strMessageMagic = "ragnarok Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 12 * 60 * 60; // ragnarok: 12 hrs
static const int64 nTargetSpacing = 60; // ragnarok: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ragnarok miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ragnarok", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xebd83086328e424341b5355f6820656de924135a1cfd3e79a5682802703667ab");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "One hundred years of the Federal Reserve";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1387665546; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3827230;

        if (fTestNet)
        {
            block.nTime    = 1387659389;
            block.nNonce   = 1000939;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xd42b1211b51fe332caef5afdffdd9f6e621df06dad8d49d077efc6a93aaa14e7"));
